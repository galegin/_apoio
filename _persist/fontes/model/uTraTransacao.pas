...
uses
  ...
  uGerOperacao, uPesPessoa, uTraTransItem;
...
type
  ...
  TTra_TransacaoListClass = class of TTra_TransItemList;
  ...
  private
    ...
    fObj_Operacao: TGer_Operacao;
    fObj_Pessoa: TPes_Pessoa;

    fLst_Itens: TTra_TransItemList;
  public
  ...
  published
    ...
    property Obj_Operacao : TGer_Operacao read fObj_Operacao write fObj_Operacao;
    property Obj_Pessoa : TPes_Pessoa read fObj_Pessoa write fObj_Pessoa;

    property Lst_Itens : TTra_TransItemList read fLst_Itens write fLst_Itens;
  end;
...
constructor TTra_Transacao.Create(Collection: TCollection);
begin
  inherited;
  Obj_Operacao := TGer_Operacao.Create(nil);
  Obj_Pessoa := TPes_Pessoa.Create(nil);
  Lst_Itens := TTra_TransItemList.Create(Self);
end;
